...
Route::middleware(['auth', 'active'])
    ...
    ->name('solicitante.')
    ->group(function () {
        Route::get('/calendario', [ReservaController::class, 'calendario'])->name('calendario.index');
        Route::get('/calendario/eventos', [ReservaController::class, 'getEventos'])->name('calendario.eventos');
...
Route::middleware(['auth', 'active', 'role:admin'])
    ...
    ->group(function () {
        ...
        Route::post('/calendario/bloquear', [CalendarioController::class, 'bloquear'])->name('calendario.bloquear');

        // Gestión de usuarios
        Route::get('/usuarios', [UsuarioController::class, 'index'])->name('usuarios.index');
        Route::post('/usuarios', [UsuarioController::class, 'store'])->name('usuarios.store');
        Route::patch('/usuarios/{usuario}/password', [UsuarioController::class, 'resetPassword'])->name('usuarios.password.reset');
